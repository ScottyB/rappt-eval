...
import com.rappt.centrelink.app.fragments.*;
...
public class TabbarActivity extends FragmentActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.firstTabId_string), MapScreenFragment_.class, null);
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.secondTabId_string), StoreFragment_.class, null);

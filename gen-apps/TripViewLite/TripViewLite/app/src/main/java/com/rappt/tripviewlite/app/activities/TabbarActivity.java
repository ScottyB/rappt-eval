...
public class TabbarActivity extends FragmentActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.firstTabId_string), DelaysScreenFragment_.class, null);
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.secondTabId_string), TrackworkScreenFragment_.class, null);
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.thirdTabId_string), NewsScreenFragment_.class, null);

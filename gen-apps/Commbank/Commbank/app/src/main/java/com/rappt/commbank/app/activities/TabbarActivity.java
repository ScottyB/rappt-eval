...
import com.rappt.commbank.app.fragments.*;
...
public class TabbarActivity extends FragmentActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.firstTabId_string), ATMFragment_.class, null);
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.secondTabId_string), BranchFragment_.class, null);

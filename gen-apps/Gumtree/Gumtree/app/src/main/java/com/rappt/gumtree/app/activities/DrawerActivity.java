package com.rappt.gumtree.app.activities;
...
public class DrawerActivity extends FragmentActivity  {
    ...
    void afterViews() {
        ...
        mAdapter.addMenuItem(SavedSearchesFragment_.class, R.string.secondTabId_string, null);
        mAdapter.addMenuItem(RecentSearchesFragment_.class, R.string.thirdTabId_string, null);

...
import com.rappt.ebay.app.fragments.*;
...
public class TabbarActivity extends FragmentActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.firstTabId_string), SignInFragment_.class, null);
        mTabsAdapter.addTab(actionBar.newTab().setText(R.string.secondTabId_string), RegisterFragment_.class, null);

package com.rappt.cleanmaster.app.activities;
...
public class DrawerActivity extends FragmentActivity  {
    ...
    void afterViews() {
        ...
        mAdapter.addMenuItem(HomeFragment_.class, R.string.homeTab_string, null);
        mAdapter.addMenuItem(MyCloudFragment_.class, R.string.firstTabId_string, null);
        mAdapter.addMenuItem(HotFragment_.class, R.string.secondTabId_string, null);
